...
export default function Commissions() {
    return (
        <div className='flex flex-col py-20 px-10 md:px-48'>
            ...
            <div>
                <FadeInContainer className='flex flex-col justify-center items-center  justify-items-center w-full gap-10 mt-20'>
            ...
            <div className='flex flex-col mt-20'>
                <div>
                    <FadeInContainer className='flex flex-col justify-between w-full items-center gap-2 md:gap-15 md:flex-row md:items-end'>
                        {/* Title */}
                        <div className='order-1 md:hidden flex flex-col items-center'>
                ...
                <div>
                    <FadeInContainer className='flex flex-col justify-center items-start  justify-items-center w-full gap-10 mt-20'>
                        <div className='flex flex-col w-full gap-5 md:flex-row'>
