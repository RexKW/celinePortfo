        ...
        <div className='flex flex-col py-20 px-10 md:px-48'>
            ...
            <div className='pb-20 rel'>
                ...
                <Image width={600} height={300} src="/portfolio/personalWorks/personalWorks8.png" className='w-full h-auto order-4' alt="" />
                            ...
                            <Image width={300} height={600} src="/main/aboutCornerBottomFlower.svg" className='w-[55%] lg:w-[17%] h-auto absolute bottom-0  right-0' alt="" />
                            ...
                            <Image width={300} height={600} src="/main/aboutCornerBottomFlower.svg" className='w-[55%] lg:w-[17%] h-auto absolute bottom-0 scale-x-[-1] left-0' alt="" />
            </div>
        </div>
    )
}
