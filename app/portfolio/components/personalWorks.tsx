...
export default function PersonalWorks() {
    return (
        <div className='flex flex-col py-20 px-10 md:px-48'>
            ...
            <div>
                <FadeInContainer className='flex flex-col justify-center items-center  justify-items-center w-full grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 mt-20'>
            ...
            <div className='pb-20 rel'>
                ...
                <Image width={600} height={300} src="/portfolio/personalWorks/personalWorks8.png" className='w-full h-auto order-4' alt="" />
                            ...
                            <Image width={300} height={600} src="/main/aboutCornerBottomFlower.svg" className='w-[40%] lg:w-[55%] lg:w-[17%] h-auto absolute bottom-0  right-[-5%]' alt="" />
                            <Image width={300} height={100} src="/portfolio/portfolioBottomBorder.svg" className='w-[45%] lg:w-[55%] lg:w-[20%] h-auto absolute bottom-25 lg:bottom-[1%] left-[50%] translate-x-[-50%]' alt="" />
                            <Image width={300} height={600} src="/main/aboutCornerBottomFlower.svg" className='w-[40%] lg:w-[55%] lg:w-[17%] h-auto absolute bottom-0 scale-x-[-1] left-[-5%]' alt="" />
            </div>
        </div>
    )
}
