  ...
  return (
    <div className='flex flex-col py-20 px-10 lg:px-48'>
      ...
      <div className='flex flex-col lg:flex-row gap-10 '>
        <FadeInContainer>
          <img src="/portfolio/chromaClub/chromaClubCharacters.png" alt="" className='w-[600px] h-auto basis-2/5' />
        </FadeInContainer>
        <div className='flex flex-col basis-3/5 lg:pt-30'>
          <div>
            <FadeInContainer>
              ...
              <p className={`text-2xl ${grenzeGotisch.className} text-justify`}><br />The Chroma Club is an original IP developed for Saekjo Studio, a personal color analysis brand based in Surabaya.
                <br />
                <br />
      ...
      <div className='flex flex-col mt-20'>
        ...
        <div className='flex flex-col justify-center items-center gap-10 lg:px-10'>
          ...
          <div>
            <FadeInContainer className='flex w-full grid grid-cols-2 gap-5 lg:gap-10 lg:grid-cols-4'>
              ...
              <div className='flex flex-col items-center'>
                <img src="/portfolio/chromaClub/chromaClubFinalLineup6.png" alt="" className=' w-auto h-auto' />
              ...
              <div className='flex flex-col items-center'>
                <img src="/portfolio/chromaClub/chromaClubFinalLineup7.png" alt="" className=' w-auto h-auto mt-5' />
          ...
          <div>
            <FadeInContainer className='flex flex-col gap-10'>
          ...
          <div className='flex flex-col relative mt-20 pb-20 w-full'>
            <FadeInContainer className=''>
              <p className='text-5xl text-center lg:text-start'>Supporting Materials</p>
            </FadeInContainer>
