...
export default class NavbarPorfo extends Component {
  render() {
    return (
      <nav className="flex fixed z-100 text-white min-w-screen top-0 items-center justify-center md:justify-end flex-row gap-5">
