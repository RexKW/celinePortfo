...
export default function PersonalWorks() {
    return (
        <div className='flex flex-col py-20 px-10 md:px-48'>
            ...
            <div className='flex flex-col justify-center items-center  justify-items-center w-full grid grid-cols-1 md:grid-cols-2 gap-10 mt-20'>
                <img src="" className='w-full h-[300px] bg-white order-1' alt="" />
                <img src="" className='w-full h-[300px] bg-white order-2' alt="" />
                <img src="" className='w-full h-[300px] bg-white order-3 md:order-4' alt="" />
            ...
            <div className='flex grid grid-cols-1  justify-items-center w-ful1 md:grid-cols-2 gap-10 mt-20'>
                <img src="" className='w-full h-[300px] bg-white order-1' alt="" />
                <img src="" className='w-full h-[300px] bg-white order-2' alt="" />
                <img src="" className='w-full h-[300px] bg-white order-3' alt="" />
                <img src="" className='w-full h-[300px] bg-white order-4' alt="" />
            </div>
        </div>
    )
}
